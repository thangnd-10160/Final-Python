...
def adsRegister():
    ...
    insertNews = "insert into "+newTable+" values('"+bid+"','"+title+"','"+author+"','"+status+"')"
    try:
        cur.execute(insertNews)
        con.commit()
        messagebox.showinfo('Success',"Ads added to VNexpress successfully")
    except:
...
def addAds():
    ...
    global Info1,Info2,Info3,Info4,Canvas1,con,cur,newTable,root
    ...
    headingLabel = Label(headingFrame1, text="Add Ads", bg='black', fg='white', font=('Courier',15))
    ...
    lb1 = Label(labelFrame,text=" Ads ID : ", bg='black', fg='white')
    ...
    # Title
    lb2 = Label(labelFrame,text="Company : ", bg='black', fg='white')
    ...
    lb3 = Label(labelFrame,text="Content : ", bg='black', fg='white')
    ...
    lb4 = Label(labelFrame,text="Status(Public/Private) : ", bg='black', fg='white')
    ...
    SubmitBtn = Button(root,text="SUBMIT",bg='#d1ccc0', fg='black',command=adsRegister)
